...
let currentHD = document.getElementById('currentHD');
let dayTwoHD = document.getElementById('dayTwoHD');
let dayThreeHD = document.getElementById('dayThreeHD');
let dayFourHD = document.getElementById('dayFourHD');
let dayFiveHD = document.getElementById('dayFiveHD');
